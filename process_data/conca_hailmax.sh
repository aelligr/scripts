#!/bin/bash
# This scripts concatenate the outloopfiles together to get files of hailsize with coords and
...
# This file cuts out all the values from the outloop files if you created them
# Required files:	- ij_local2global.pl (to calculate actual coords)
#			- outloopfiles: outloop<ttttt><cccc><iii><jjj><ss>
# t = timestep
# c = mycartid
# i = local_i in model
# j = local_j in model
# s = which hailstone of the 5
# e.g.: outloop05880234600801104
